...
| Module | Status | Evidence |
|---|---|---|
| `certified_kernels/chunkable_stability_v1.py` | VERIFIED-FRESH | 7/7 own gates, full two-process repeats; unstable error437.3193359375 refused, stable numerical failure retained. |
