...
g++ -O2 -std=c++17 -I"$OPTIX_INCLUDE" -I"$CUDA_ROOT/include" "$rt_source/host.cpp" -L"$CUDA_ROOT/lib64" -Wl,-rpath,"$CUDA_ROOT/lib64" -lcudart -ldl -o "$RT_BUILD_DIR/rt_winding_phase"
