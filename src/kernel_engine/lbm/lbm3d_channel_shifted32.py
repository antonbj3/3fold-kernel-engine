"""Experimental shifted FP32 collision: f-w and equilibrium deviations.
Subtract/restore reference weights in FP64; int64 state/repair unchanged.
"""
import warp as wp
...
@wp.kernel
def shifted32_collide_stream(a: wp.array4d(dtype=wp.int64), b: wp.array4d(dtype=wp.int64),
...
class Shifted32ChannelSimulation(ChannelSimulation):
    ...
    def step(self,steps=1):
        ...
        for _ in range(steps):
            wp.launch(shifted32_collide_stream,self.shape,[self.a,self.b,*self.specialized_args],device=self.device)
