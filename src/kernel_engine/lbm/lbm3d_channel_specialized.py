"""Experimental compile-time Hermite matrices; exact-parity gate required.

Derived from lbm3d_channel.py collision source SHA256: 98389d34fe93eb77fdbeb86a0a186f284e50c5e1335e52a85073630997b38c63
The streaming, quantization and arithmetic ordering are preserved. Only the
basis matrices become compile-time values, removing them from launch inputs.
"""
import warp as wp
...
@wp.kernel
def specialized_collide_stream(a: wp.array4d(dtype=wp.int64), b: wp.array4d(dtype=wp.int64),
...
class SpecializedChannelSimulation(ChannelSimulation):
    ...
    def step(self,steps=1):
        ...
        for _ in range(steps):
            wp.launch(specialized_collide_stream,self.shape,[self.a,self.b,*self.specialized_args],device=self.device)
