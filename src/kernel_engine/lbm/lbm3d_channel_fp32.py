"""Experimental FP32 collision; int64 storage, repair and ledgers unchanged.
...
@wp.kernel
def fp32_collide_stream(a: wp.array4d(dtype=wp.int64), b: wp.array4d(dtype=wp.int64),
...
class FP32ChannelSimulation(ChannelSimulation):
    ...
    def step(self,steps=1):
        ...
        for _ in range(steps):
            wp.launch(fp32_collide_stream,self.shape,[self.a,self.b,*self.specialized_args],device=self.device)
