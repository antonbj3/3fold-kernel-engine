...
| `certified_kernels/innovation_flow_scale_probe.py` | Add frozen flow-control gradient/update-scale and bounded-control response measurement with exact repeats and unchanged FD checks. | Diagnose the retained zero-recovery selftest before changing its driver. |
