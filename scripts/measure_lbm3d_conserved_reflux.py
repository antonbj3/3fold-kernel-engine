"""Conserved-mode candidate: numerical parity, startup, then original DNS gate."""
import subprocess,sys
from measure_lbm3d_refinement_sgs import main as numerical_gate


if __name__=='__main__':
    status=numerical_gate(recursive=True,bulk_tau_fine=1.,conserved_reflux=True,
                          output='reports/lbm3d_conserved_reflux_gates_v1/report.json')
    ...
    cmd=[sys.executable,'scripts/measure_lbm3d_refined_dns.py',
         ...
         '--wall-cells','12','--conserved-reflux']
