...
import numpy as np
import warp as wp
from kernel_engine.lbm.lbm3d_channel_specialized import SpecializedChannelSimulation as ChannelSimulation
from kernel_engine.lbm.lbm3d_channel_split import SplitChannelSimulation as SpecializedChannelSimulation
...
def main():
    ...
    result={'scope':'split versus fused FP64 full refined-step parity/timing; extra19int64 values per allocated cell; no new turbulent accuracy claim',
    ...
    p=Path('reports/lbm3d_split_v1/report.json');p.parent.mkdir(parents=True,exist_ok=True)
